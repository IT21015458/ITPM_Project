    ...
    return (
        <>
          ...
          <div id="carouselExampleDark" className="carousel slide" data-bs-ride="carousel">
            ...
            <div className={NavigationPageCSS.headerContainer}>
              ...
              <div id={NavigationPageCSS.buttonContainer}>
                <button type="button" class="btn btn-success" id={NavigationPageCSS.button1}>සිංහල </button>
                <button type="button" class="btn btn-success" id={NavigationPageCSS.button1}>English</button>
              </div>
            </div>
